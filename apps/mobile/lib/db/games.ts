...
import type { GameStatus } from "@huddlestat/shared";
...
export async function createLocalGame(
  ...
  await database.runAsync(
    `INSERT INTO games (id, slug, team_code, opponent, convex_game_id, home_score, away_score, status, created_at, updated_at)
     VALUES (?, ?, ?, ?, NULL, 0, 0, 'pregame', ?, ?)`,
